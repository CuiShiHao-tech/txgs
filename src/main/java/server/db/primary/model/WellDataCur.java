...
public class WellDataCur implements Serializable {
    private Long id;
    ...
    private BigDecimal systemEff;

    public BigDecimal getSystemEff() {
        return systemEff;
    }

    public void setSystemEff(BigDecimal systemEff) {
    ...
    public void setGtDiagInfo(String gtDiagInfo) {
        this.gtDiagInfo = gtDiagInfo == null ? null : gtDiagInfo.trim();
    }
    ...
    public void setGtProd(String gtProd) {
        this.gtProd = gtProd == null ? null : gtProd.trim();
    }
